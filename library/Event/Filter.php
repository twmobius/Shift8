 ...
 * @version 0.1
 */
abstract class Shift8_Event_Filter {
	/**
	 * The filter method must be implemented by all extensions in order to verify and event to the
	 * listener. 
	 *
	 * @param string $event
	 *
	 * @return boolean
	 */
	public abstract function filter( $event );
}
